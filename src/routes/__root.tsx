...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Saad Mulla — DevOps & Cloud Engineer" },
      { name: "description", content: "Portfolio of Saad Mulla, DevOps & Cloud Engineer based in Pune. AWS, Docker, Kubernetes, Terraform, CI/CD." },
      { name: "author", content: "Saad Mulla" },
